...
import (
	...
	v121 "github.com/gravitational/teleport/api/gen/proto/go/teleport/subca/v1"
	v122 "github.com/gravitational/teleport/api/gen/proto/go/teleport/summarizer/v1"
...
func (x *Event) GetCertAuthorityOverride() *v121.CertAuthorityOverride {
	if x != nil {
...
func (x *Event) GetInferenceModel() *v122.InferenceModel {
	if x != nil {
...
func (x *Event) GetInferenceSecret() *v122.InferenceSecret {
	if x != nil {
...
func (x *Event) GetInferencePolicy() *v122.InferencePolicy {
	if x != nil {
...
func (x *Event) GetRetrievalModel() *v122.RetrievalModel {
	if x != nil {
...
type Event_CertAuthorityOverride struct {
	...
	CertAuthorityOverride *v121.CertAuthorityOverride `protobuf:"bytes,90,opt,name=CertAuthorityOverride,proto3,oneof"`
}

type Event_InferenceModel struct {
	// InferenceModel is a resource for defining inference models.
	InferenceModel *v122.InferenceModel `protobuf:"bytes,91,opt,name=InferenceModel,proto3,oneof"`
}

type Event_InferenceSecret struct {
	// InferenceSecret is a resource for defining inference secrets.
	InferenceSecret *v122.InferenceSecret `protobuf:"bytes,92,opt,name=InferenceSecret,proto3,oneof"`
}

type Event_InferencePolicy struct {
	// InferencePolicy is a resource for defining inference policies.
	InferencePolicy *v122.InferencePolicy `protobuf:"bytes,93,opt,name=InferencePolicy,proto3,oneof"`
}

type Event_RetrievalModel struct {
	// RetrievalModel is a resource for defining retrieval models.
	RetrievalModel *v122.RetrievalModel `protobuf:"bytes,94,opt,name=RetrievalModel,proto3,oneof"`
}
...
var file_teleport_legacy_client_proto_event_proto_goTypes = []any{
	...
	(*v121.CertAuthorityOverride)(nil),          // 80: teleport.subca.v1.CertAuthorityOverride
	(*v122.InferenceModel)(nil),                 // 81: teleport.summarizer.v1.InferenceModel
	(*v122.InferenceSecret)(nil),                // 82: teleport.summarizer.v1.InferenceSecret
	(*v122.InferencePolicy)(nil),                // 83: teleport.summarizer.v1.InferencePolicy
	(*v122.RetrievalModel)(nil),                 // 84: teleport.summarizer.v1.RetrievalModel
}
var file_teleport_legacy_client_proto_event_proto_depIdxs = []int32{
	...
	80, // 82: proto.Event.CertAuthorityOverride:type_name -> teleport.subca.v1.CertAuthorityOverride
	81, // 83: proto.Event.InferenceModel:type_name -> teleport.summarizer.v1.InferenceModel
	82, // 84: proto.Event.InferenceSecret:type_name -> teleport.summarizer.v1.InferenceSecret
	83, // 85: proto.Event.InferencePolicy:type_name -> teleport.summarizer.v1.InferencePolicy
	84, // 86: proto.Event.RetrievalModel:type_name -> teleport.summarizer.v1.RetrievalModel
