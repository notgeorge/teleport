...
|disconnect_expired_cert|boolean|DisconnectExpiredCert controls whether SSH sessions are disconnected when the user certificate expires. If unset, cluster-wide auth preference applies.|
...
|lock|[object](#specsshlock)|Lock configures the role's locking behavior.|
