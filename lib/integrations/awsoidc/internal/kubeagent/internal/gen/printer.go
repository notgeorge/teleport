...
// we don't rely on Go's composite-literal type elision in slice/map element
// contexts.
...
// writeString emits a string literal. Named-type strings (e.g.
// corev1.PullPolicy) are wrapped in a cast.
...
// isNamedType reports whether t is a defined type (e.g. corev1.Protocol)
// rather than an unnamed builtin.
