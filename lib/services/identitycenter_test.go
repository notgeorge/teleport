...
func TestIdentityCenterAccountToAppServer(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Outer (storage key) must match inner (routing identity).
			...
			// Round-trip through ValidateApp so that any future
			// tightening of the write-path validation surfaces here.
